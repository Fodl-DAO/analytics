...
interface ILendingPlatformInterface extends ethers.utils.Interface {
  functions: {
...
export class ILendingPlatform extends BaseContract {
  ...
  interface: ILendingPlatformInterface;
