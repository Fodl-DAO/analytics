...
interface FodlEthSLPStakingInterface extends ethers.utils.Interface {
  functions: {
...
export class FodlEthSLPStaking extends BaseContract {
  ...
  interface: FodlEthSLPStakingInterface;
