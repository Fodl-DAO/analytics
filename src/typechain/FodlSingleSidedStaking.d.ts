...
interface FodlSingleSidedStakingInterface extends ethers.utils.Interface {
  functions: {
...
export class FodlSingleSidedStaking extends BaseContract {
  ...
  interface: FodlSingleSidedStakingInterface;
