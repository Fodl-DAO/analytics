...
interface TimelockGovernanceInterface extends ethers.utils.Interface {
  functions: {
...
export class TimelockGovernance extends BaseContract {
  ...
  interface: TimelockGovernanceInterface;
