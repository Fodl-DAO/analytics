...
interface IFodlNFTProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class IFodlNFTProvider extends BaseContract {
  ...
  interface: IFodlNFTProviderInterface;
