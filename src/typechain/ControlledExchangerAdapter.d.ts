...
interface ControlledExchangerAdapterInterface extends ethers.utils.Interface {
  functions: {
...
export class ControlledExchangerAdapter extends BaseContract {
  ...
  interface: ControlledExchangerAdapterInterface;
