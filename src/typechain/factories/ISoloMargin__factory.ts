...
import type { ISoloMargin, ISoloMarginInterface } from "../ISoloMargin";
    ...
    inputs: [
      {
        ...
        internalType: "struct ISoloMargin.OperatorArg[]",
        name: "args",
        type: "tuple[]",
      },
    ],
...
export class ISoloMargin__factory {
  static readonly abi = _abi;
  static createInterface(): ISoloMarginInterface {
    return new utils.Interface(_abi) as ISoloMarginInterface;
  }
  static connect(
    address: string,
    signerOrProvider: Signer | Provider
  ): ISoloMargin {
    return new Contract(address, _abi, signerOrProvider) as ISoloMargin;
  }
}
