...
interface SimplePositionBaseConnectorInterface extends ethers.utils.Interface {
  functions: {
...
export class SimplePositionBaseConnector extends BaseContract {
  ...
  interface: SimplePositionBaseConnectorInterface;
