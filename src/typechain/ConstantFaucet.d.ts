...
interface ConstantFaucetInterface extends ethers.utils.Interface {
  functions: {
    "DURATION()": FunctionFragment;
    "TOTAL_FODL()": FunctionFragment;
    "amountDistributed()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "amountDistributed",
    values?: undefined
  ): string;
  encodeFunctionData(
...
export class ConstantFaucet extends BaseContract {
  ...
  interface: ConstantFaucetInterface;
  ...
  functions: {
    ...
    amountDistributed(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    amountDistributed(overrides?: CallOverrides): Promise<PopulatedTransaction>;
