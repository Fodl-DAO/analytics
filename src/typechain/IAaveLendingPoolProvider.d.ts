...
interface IAaveLendingPoolProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class IAaveLendingPoolProvider extends BaseContract {
  ...
  interface: IAaveLendingPoolProviderInterface;
