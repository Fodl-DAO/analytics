...
interface ControlledExchangerInterface extends ethers.utils.Interface {
  functions: {
...
export class ControlledExchanger extends BaseContract {
  ...
  interface: ControlledExchangerInterface;
  ...
  functions: {
    ...
    setPriceUpdate(
      token: string,
      priceChangeFactor: BigNumberish,
