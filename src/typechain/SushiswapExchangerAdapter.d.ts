...
interface SushiswapExchangerAdapterInterface extends ethers.utils.Interface {
  functions: {
...
export class SushiswapExchangerAdapter extends BaseContract {
  ...
  interface: SushiswapExchangerAdapterInterface;
