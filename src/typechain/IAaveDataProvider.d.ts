...
interface IAaveDataProviderInterface extends ethers.utils.Interface {
  functions: {
...
export class IAaveDataProvider extends BaseContract {
  ...
  interface: IAaveDataProviderInterface;
