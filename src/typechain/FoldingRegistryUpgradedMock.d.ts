...
interface FoldingRegistryUpgradedMockInterface extends ethers.utils.Interface {
  functions: {
    ...
    "newStorageVariable()": FunctionFragment;
    "newViewFunction()": FunctionFragment;
    ...
    "setNewStorageVariable(uint256)": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "newStorageVariable",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "newViewFunction",
    values?: undefined
  ): string;
  ...
  encodeFunctionData(
    functionFragment: "setNewStorageVariable",
    values: [BigNumberish]
  ): string;
  encodeFunctionData(
...
export class FoldingRegistryUpgradedMock extends BaseContract {
  ...
  interface: FoldingRegistryUpgradedMockInterface;
  ...
  functions: {
    ...
    newStorageVariable(overrides?: CallOverrides): Promise<[BigNumber]>;

    newViewFunction(overrides?: CallOverrides): Promise<[boolean]>;
  ...
  estimateGas: {
    ...
    newViewFunction(overrides?: CallOverrides): Promise<BigNumber>;
  ...
  populateTransaction: {
    ...
    newViewFunction(overrides?: CallOverrides): Promise<PopulatedTransaction>;
