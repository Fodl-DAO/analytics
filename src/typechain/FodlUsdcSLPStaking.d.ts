...
interface FodlUsdcSLPStakingInterface extends ethers.utils.Interface {
  functions: {
...
export class FodlUsdcSLPStaking extends BaseContract {
  ...
  interface: FodlUsdcSLPStakingInterface;
